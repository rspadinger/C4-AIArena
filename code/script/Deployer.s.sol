...
contract DeployerScript is Script {
    ...
    address[2] public adminAddresses = [0xb2B2d81CD161c198C81072091EEae09b7bBcCb40, 0x91832Bc473daB70e9490cFC2c268e0Ab293f01d5];
    ...
    function run() public {
        ...
        RankedBattle rankedBattle = new RankedBattle(deployerAddress, gameServerAddress, address(fighterFarm), address(voltageManager));
        ...
        gameItems.createGameItem("battery", "https://ipfs.io/ipfs/bafybeibhi6d5l2oqv63gczy6qwprzsspn5t6d5uuvadpl2afzvgtv44h7u", false, false, 0, 10 * 10 ** 18, 5);
