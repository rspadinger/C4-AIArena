...
contract FighterFarmTest is Test {
    ...
    function setUp() public {
        ...
        _rankedBattleContract = new RankedBattle(_ownerAddress, address(_fighterFarmContract), _DELEGATED_ADDRESS, address(_voltageManagerContract));
    ...
    function testRedeemMintPass() public {
        ...
        _fighterFarmContract.redeemMintPass(_mintpassIdsToBurn, _fighterTypes, _iconsTypes, _mintPassDNAs, _neuralNetHashes, _modelTypes);
    ...
    function testUpdateModelFromTokenOwner() public {
        //game server sets the modelHash
        _fighterFarmContract.setModelHashForTokenId(0, "newModelHash1");
    ...
    function testReroll() public {
        ...
        if (_fighterFarmContract.ownerOf(0) == _ownerAddress) {
            ...
            console.log("Allowance: ", _neuronContract.allowance(_ownerAddress, address(_fighterFarmContract)));
    ...
    function testRerollRevertWhenLimitExceeded() internal {
        _mintFromMergingPool(_ownerAddress);
        // get 4k neuron from treasury
        _fundUserWith4kNeuronByTreasury(_ownerAddress);
        // after successfully minting a fighter, update the model
