...
contract MergingPoolTest is Test {
    ...
    function testPickWinner2() public {
    ...
    function testClaimRewardsForWinnersOfMultipleRoundIds() public {
        ...
        _customAttributes[1][0] = uint256(2);
        _customAttributes[1][1] = uint256(80);
        _customAttributes[2][0] = uint256(3);
    ...
    function testGetFighterPoints() public {
        ...
        _mintFromMergingPool(_ownerAddress);
        _mintFromMergingPool(_ownerAddress);
        address owner = _fighterFarmContract.ownerOf(1);
        ...
        _mergingPoolContract.addPoints(0, 100);
        vm.prank(address(_rankedBattleContract));
        _mergingPoolContract.addPoints(1, 75);
        //assertEq(_mergingPoolContract.totalPoints(), 175);
        ...
        console.log(_mergingPoolContract.getSingleFighterPoints(0));
        console.log(_mergingPoolContract.getSingleFighterPoints(1));
