...
contract VoltageManager {
    ...
    function useVoltageBattery() public {
        //@audit-ok careful, if user is at level 99, he uses 1 entire game item to get from level 99 to 100
        require(ownerVoltage[msg.sender] < 100);
        // balance of item 0 => user has at least 1 game item
        require(_gameItemsContractInstance.balanceOf(msg.sender, 0) > 0);
        //@audit-ok why item 0 == battery ? => check how GameItems are used - user doesnt necessarily have item 0
    ...
    function spendVoltage(address spender, uint8 voltageSpent) public {
        //@audit-ok where are allowedVoltageSpenders set => only RankedBattle
        ...
        //@audit-ok underflow => check amounts
        ownerVoltage[spender] -= voltageSpent;
        //console.log("Voltage: ", ownerVoltage[spender]);
